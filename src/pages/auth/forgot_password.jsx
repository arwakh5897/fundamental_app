...
const ForgotPassword = () => {
  ...
  return (
<div className="min-h-screen flex items-center justify-center bg-menu-gradiant px-4">      
    <div className="bg-background p-6 rounded-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button 
          className="w-full bg-buttons hover-bg-buttons hover:cursor-pointer text-xs text-foreground-secondary py-3 rounded-lg"
          disabled={loading}
          >

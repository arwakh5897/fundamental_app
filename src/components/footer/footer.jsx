...
const Footer = () => {
    return (
        <footer className="bg-footer md:pt-8 md:p-4 px-4 md:sticky md:bottom-0">
            <div className="flex flex-col pt-6 pb-8 md:py-8 md:flex-row gap-8 md:gap-2 md:text-start justify-around">
                <AboutUs/>
                <CustomerCare/>
                <ProductsLinks/>
                <FollowUs/>

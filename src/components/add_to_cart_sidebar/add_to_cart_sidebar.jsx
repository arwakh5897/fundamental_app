...
const AddToCartSidebar = ({ active, onClose, totalItems, totalPrice, cart = [], onRemove = () => {} }) => {
  return (
    <>
      ...
      <nav
       data-lenis-prevent
        className={`fixed top-0 right-0 h-full w-72 md:w-92 bg-sidebar text-foreground-secondary z-50 flex flex-col transition-transform duration-1000 transform ${

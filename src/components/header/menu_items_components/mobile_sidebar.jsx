...
const MobileSidebar = ({ active, onClose }) => {
  return (
    <>
      ...
      {/* Sidebar */}
      <nav
        className={`fixed top-0 left-0 h-full w-72 md:w-86 bg-menu-gradiant text-foreground-secondary z-50 p-0 flex flex-col justify-between transition-transform duration-1000 ${
